...
2. Specify `welcome-to-docker` in the search input and then select the **Pull** button.
    ...
    ![A screenshot of the Docker Desktop Dashboard showing the search result for welcome-to-docker Docker image ](/get-started/docker-concepts/the-basics/what-is-a-container/images/search-the-docker-image.webp?border=true&w=1000&h=700)
...
6. In the **Host port**, specify `8080`.
    ...
    ![A screenshot of Docker Desktop Dashboard showing the container run dialog with welcome-to-docker typed in as the container name and 8080 specified as the port number](/get-started/docker-concepts/the-basics/what-is-a-container/images/run-a-new-container.webp?border=true&w=550&h=400)
...
![Screenshot of the container view of the Docker Desktop GUI showing the welcome-to-docker container running on the host port 8080](/get-started/docker-concepts/the-basics/what-is-a-container/images/view-your-containers.webp?border=true&w=750&h=600)
...
![Screenshot of the landing page coming from the running container](/get-started/docker-concepts/the-basics/what-is-a-container/images/access-the-frontend.webp?border)
...
3. Select the **Files** tab to explore your container's isolated file system.
    ...
    ![Screenshot of the Docker Desktop Dashboard showing the files and directories inside a running container](/get-started/docker-concepts/the-basics/what-is-a-container/images/explore-your-container.webp?border)
...
3. Select the **Stop** action in the **Actions** column.
    ...
    ![Screenshot of the Docker Desktop Dashboard with the welcome container selected and being prepared to stop](/get-started/docker-concepts/the-basics/what-is-a-container/images/stop-your-container.webp?border)
...
![Screenshot of the landing page of the Nginx web server, coming from the running container](/get-started/docker-concepts/the-basics/what-is-a-container/images/access-the-frontend.webp?border)
...
[What is an image?](/get-started/docker-concepts/the-basics/what-is-a-container/what-is-an-image)
